...
** LaTeX
*** Packages
Auto activating snippets for convenience
...
** All The Icons
all-the-icons does a generally great job giving file names icons. One minor issue I have is that when I open a .m file, it’s much more likely to be Matlab than Objective-C. As such, it’ll be switching the icon associated with .m
#+begin_src elisp :tangle config.el
(after! all-the-icons
